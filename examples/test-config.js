...
var config3 = { name: "test3", headers: { terminalId: "term3" }, iface: iface1, debug: {ztrans: true} }
var config4 = { name: "test4", headers: { terminalId: "term4" }, iface: iface1, debug: {ztrans: true} }
